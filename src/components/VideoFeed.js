...
const VideoFeed = () => {
  ...
  const buildQuery = useCallback(() => {
    ...
    if (selectedBrand && selectedBrand !== 'all') return `${selectedBrand} smartphone review 2025`;
  ...
  }, [selectedMaker, selectedModel, activeTag, selectedBrand]);
  ...
  useEffect(() => {
    fetchVideos();
  }, [selectedMaker, selectedModel, activeTag, selectedBrand]); // eslint-disable-line react-hooks/exhaustive-deps
